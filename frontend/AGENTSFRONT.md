...
Crée un fichier AGENTS.md à la racine du dossier frontend pour définir les règles du projet.

Le fichier doit préciser :
...
Ajoute aussi la section suivante dans le fichier AGENTS.md :
...
À la fin :
- affiche-moi le contenu complet du fichier AGENTS.md